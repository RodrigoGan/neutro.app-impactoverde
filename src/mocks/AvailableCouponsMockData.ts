...
// MOCKS PARA TESTE DE FORMULÁRIO DE EDIÇÃO DE CUPOM
export const couponEditMockRestaurant = {
  name: 'Desconto Buffet',
  discountType: 'percentage',
  value: '20',
  expiresAt: new Date('2024-12-31'),
  quantity: 50,
  userLimit: 1,
  description: 'Desconto especial para buffet livre',
  rules: ['Válido apenas para almoço', 'Não cumulativo'],
  ...
  storeCategories: [],
  educationalType: '',
  digitalMaterial: null,
};

export const couponEditMockStore = {
  name: 'Desconto Linha Eco',
  discountType: 'fixed',
  value: '50',
  expiresAt: new Date('2024-11-30'),
  quantity: 30,
  userLimit: 1,
  description: 'Desconto em produtos da linha eco',
  rules: ['Válido para compras acima de R$ 200'],
  cancellationPolicy: 'Cancelamento até 48h antes',
  customerService: '0800 888 9999',
  restaurantType: '',
  customRestaurantType: '',
  storeCategories: ['eco'],
...
export const couponEditMockEducational = {
  name: 'Desconto em E-book',
  discountType: 'percentage',
  value: '40',
  expiresAt: new Date('2024-10-15'),
  quantity: 100,
  userLimit: 1,
  description: 'Desconto em e-books de sustentabilidade',
  rules: ['Válido para todos os e-books da plataforma'],
  cancellationPolicy: 'Reembolso em até 7 dias',
  customerService: '0800 555 6666',
  restaurantType: '',
  customRestaurantType: '',
  storeCategories: [],
  educationalType: 'ebook',
  digitalMaterial: null,
};

export const couponEditMockRestaurantOutros = {
  name: 'Desconto Vegano',
  discountType: 'fixed',
  value: '15',
  expiresAt: new Date('2024-09-30'),
  quantity: 20,
  userLimit: 1,
  description: 'Desconto especial para pratos veganos',
  rules: ['Válido apenas para pratos veganos'],
  cancellationPolicy: 'Cancelamento até 12h antes',
