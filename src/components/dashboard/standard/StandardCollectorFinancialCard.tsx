...
import { DollarSign, Package, TrendingUp, History } from 'lucide-react';
...
interface StandardCollectorFinancialCardProps {
...
export const StandardCollectorFinancialCard: React.FC<StandardCollectorFinancialCardProps> = ({
  monthlyEarnings,
  monthlyGoal,
  materialSales,
  isLinked = false
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Button 
                variant="ghost" 
                size="sm"
                onClick={() => navigate('/collector/sales-history')}
              >
