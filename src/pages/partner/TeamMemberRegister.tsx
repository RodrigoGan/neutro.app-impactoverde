...
const FUNCTION_OPTIONS_MAP: Record<PartnerType, string[]> = {
  restaurant: [
    'Gerente',
    'Atendente',
    'Caixa',
...
const TeamMemberRegister: React.FC = () => {
  ...
  const type = (searchParams.get('type') as PartnerType) || 'store';
  ...
  const FUNCTION_OPTIONS = FUNCTION_OPTIONS_MAP[type];
