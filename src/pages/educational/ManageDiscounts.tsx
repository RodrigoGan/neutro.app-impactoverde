...
import { Percent, Users, Calendar, Target } from 'lucide-react';
...
const ManageDiscounts: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <h1 className="text-2xl font-bold mb-6">Gestão de Descontos Educacionais</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                <div>
                  <p className="font-medium">Desconto Estudante</p>
                  <p className="text-sm text-muted-foreground">15% em todas as coletas</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                <div>
                  <p className="font-medium">Desconto Professor</p>
                  <p className="text-sm text-muted-foreground">20% em coletas mensais</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                <div>
                  <p className="font-medium">Desconto Instituição</p>
                  <p className="text-sm text-muted-foreground">25% em volume</p>
                </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="text-center p-3 bg-green-50 rounded-lg">
                <p className="text-2xl font-bold text-green-600">R$ 3,450</p>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">856 usos</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>Desconto Professor</span>
                <span className="font-medium">234 usos</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>Desconto Instituição</span>
                <span className="font-medium">157 usos</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <Label htmlFor="maxUses">Uso Máximo por Pessoa</Label>
              <Input 
                id="maxUses" 
                type="number"
                placeholder="5"
