...
import { Percent, Users, Calendar, Target, Utensils } from 'lucide-react';
...
const ManageDiscounts: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <h1 className="text-2xl font-bold mb-6">Gestão de Descontos do Restaurante</h1>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">10% para clientes sustentáveis</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">15% em grandes volumes</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">5% para clientes recorrentes</p>
                </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="text-center p-3 bg-green-50 rounded-lg">
                <p className="text-2xl font-bold text-green-600">R$ 2,340</p>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">456 usos</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>Volume</span>
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">202 usos</span>
              </div>
            </div>
          </CardContent>
        </Card>
